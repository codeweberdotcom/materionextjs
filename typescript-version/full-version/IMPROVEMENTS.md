...
- **Unit-тесты.** Настроить Jest/RTL/ViTest, покрыть хотя бы: rate-limit сервис, notifications/chat socket-слой, NextAuth utils, Prisma репозитории. Добавить запуск в CI и smoke-сценарии для новых типов.
